...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "me.bruce.oschina";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "oschina";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "me.bruce.oschina.sync";
    ...
    public static final class Http {
         ...
         */
        public static final String URL_BASE = "https://www.oschina.net";
         ...
         * List News URL
         */
        public static final String URL_NEWS_FRAG = "/action/api/news_list";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "me.bruce.oschina.";
