...
[![Build Status](https://travis-ci.org/AndroidBootstrap/me-bruce-oschina.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/me-bruce-oschina)

This repository contains the source code for the [oschina](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=me.bruce.oschina).

Please see the [issues](https://github.me.bruce.oschina/me-bruce-oschina/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about oschina? Ask away on the [me-bruce-oschina discussion forum](https://groups.google.com/forum/#!forum/me-bruce-oschina).

<a href="https://play.google.com/store/apps/details?id=me.bruce.oschina" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __me.bruce.oschina__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____me.bruce.oschina__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.me.bruce.oschina.R__) will now be renamed
...
signed with a different key.  Manually uninstall oschina from your device and
...
oschina is a result of a template project I've developed over the years as well as
...
oschina is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.me.bruce.oschina/me-bruce-oschina/contributors) on
...
[pull requests](https://github.me.bruce.oschina/me-bruce-oschina/pulls).
